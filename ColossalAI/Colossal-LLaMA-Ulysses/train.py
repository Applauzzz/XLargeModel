...
from mistral.modeling_mistral import MistralForCausalLM, initialize_model_parallel
...
if __name__ == "__main__":
    ...
    wandb.init(project="sft_mistral_7B_3M_bs8", name="stage1/3M", save_code=False, force=False)
