...
class GLAMLP(nn.Module):
    ...
    def __init__(
        ...
        self.gate_proj = lora.Linear(self.hidden_size, self.intermediate_size, bias=False, r=256, lora_alpha=512, lora_dropout=0.1)
        self.up_proj = lora.Linear(self.hidden_size, self.intermediate_size, bias=False, r=256, lora_alpha=512, lora_dropout=0.1)
        self.down_proj = lora.Linear(self.intermediate_size, self.hidden_size, bias=False, r=256, lora_alpha=512, lora_dropout=0.1)
...
class GatedLinearAttention(nn.Module):
    def __init__(
        ...
        self.g_norm = RMSNorm(hidden_size=self.head_dim, elementwise_affine=elementwise_affine, eps=norm_eps)
...
class GLAModel(GLAPreTrainedModel):
    ...
    def __init__(self, config: GLAConfig):
        ...
        self.embeddings = lora.Embedding(config.vocab_size, config.hidden_size, padding_idx=self.padding_idx, r=256, lora_alpha=512)
...
class GLAloraForCausalLM(GLAPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.vocab_size = config.vocab_size
        self.lm_head = lora.Linear(config.hidden_size, config.vocab_size, bias=False, r=256, lora_alpha=512)
