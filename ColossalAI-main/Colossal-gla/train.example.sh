...
colossalai run --nproc_per_node 8  train_ori.py \
    --pretrained /data/home/scyb039/modelbase/gla-infins \
    --dataset ${dataset[@]} \
    --plugin "zero2" \
    --save_interval 400 \
    --save_dir "/data/home/scyb039/modelbase/saved_ckpt/Mistral" \
    --tensorboard_dir "/data/home/scyb039/modelbase/saved_ckpt/gla/tensorboard" \
    --config_file "/data/home/scyb039/modelbase/saved_ckpt/gla/run_config.json" \
    --num_epochs 1 \
